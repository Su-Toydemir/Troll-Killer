    ...
    <div id="main">
        ...
        <div class="container">
            <div style="text-align:center">
                <h2>Contact Us</h2>
                <h4>Leave us suggestions about which accounts we should analyze next.</h4>
            </div>
            <div class="ro">
                <div class="column">
                    <img src="suggest.png" style="width:150%; margin-left: 50px;">
                </div>
                <div class="col">
                    <form action="Twitter_ContactAction.php" method="post">
                        ...
                        <label for="subject">Write your suggestions and requests here</label>
                        <textarea id="subject" name="message" placeholder="Your Message..." style="height:170px"></textarea>
